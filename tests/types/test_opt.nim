...
suite "ic_opt tests":
  test "serializeCandid with option some nat8":
  ...
  test "serializeCandid with option none":
  ...
  test "serializeCandid with option some text":
  ...
  test "serializeCandid with option some bool":
  ...
  test "option value type check":
    ...
    check optValue.optVal.get().intVal == -1000
